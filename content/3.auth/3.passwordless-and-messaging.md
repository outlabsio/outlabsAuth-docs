...
With frontend profiles configured (`0.1.0a25+`), requests may name a
registered `app` key and verification responses carry a server-validated
canonical `next_url` — see [Multi-Frontend Support](/auth/multi-frontend).
